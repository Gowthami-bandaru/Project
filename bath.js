...
function PartyReady(){
    ...
    bathroom2 = createSprite(250, 250);
bathroom2.addImage(bathroom2Img);
bathroom2.scale = 1.3;
bathroom2.visible = false;
...
p4 = createSprite(210 , 90);
p4.addImage(p4Img);
p4.scale = 0.45;

p5 = createSprite(305 , 150);
p5.addImage(p5Img);
p5.scale =1;


pCorrect = createSprite(380 , 250);
pCorrect.addImage(pCorrectImg);
pCorrect.scale =0.28;

p6 = createSprite(250 ,150);
p6.addImage(p6Img);
p6.scale =0.9;
p1.debug=true;
p2.debug= true;
...
p1.setCollider("circle", 0, 0, 10);
p2.setCollider("circle", 0, 0, 10);
p3.setCollider("circle", 0, 0, 10);
p4.setCollider("circle", 0, 0, 10);
p5.setCollider("circle", 0, 0, 10);
p6.setCollider("circle", 0, 0, 10);
pCorrect.setCollider("circle", 0, 0, 10);
