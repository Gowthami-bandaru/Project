...
bathroom2Img = loadImage("images 2/Bathroom-2.jpg");

whyBuy = loadSound("images/noIdea.mp3");
perfecto = loadSound("images/perfecto.mp3");

p1Img = loadImage("images 2/pd1.png");
p2Img = loadImage("images 2/pd2.png");
p3Img = loadImage("images 2/pd3.png");
p4Img = loadImage("images 2/pd4.png");
p5Img = loadImage("images 2/pd5.png");
p6Img = loadImage("images 2/pd5.png");
pCorrectImg = loadImage("images 2/pCorrect.png")
bathroomImg = loadImage("images/washroom.jpg");
nada = loadSound("images 2/Nada.mp3");
whyBuy = loadSound("images/noIdea.mp3");
perfecto = loadSound("images/perfecto.mp3");



preadyImg =  loadImage("images 2/pd1.png");
partyImg = loadImage("images 2/party.png");
...
function draw() {
  background(0);
  console.log("Ettiquette 2 Score" + e3Score)
  if(gameState===0)
  {
...
bathroom2.visible = true;

hand1= createSprite(120 , 250);
hand1.addImage(handImg)
hand1.scale = 0.1;
hand1.depth = bathroom2.depth;
hand1.depth+=1;
if(keyDown(DOWN_ARROW)){
  hand1.y +=5
}
...
p5.visible = true;
p6.visible = true;
pCorrect.visible = true;


p1.depth = bathroom2.depth;
p1.depth+=1

p2.depth = bathroom2.depth;
p2.depth+=1

p3.depth = bathroom2.depth;
p3.depth+=1

p4.depth = bathroom2.depth;
p4.depth+=1

p5.depth = bathroom2.depth;
p5.depth+=1

p6.depth = bathroom2.depth;
p6.depth+=1

pCorrect.depth = bathroom2.depth;
pCorrect.depth+=1

if(hand1.isTouching(p1)){
  abc = createSprite(200,200,100,100);
}
if(hand1.isTouching(p2)){
  abc2 = createSprite(200,200,100,100);
}
if(hand1.isTouching(p3)){
  abc3 = createSprite(200,200,100,100);
}
if(hand1.isTouching(p4)){
  abc4 = createSprite(200,200,100,100);
}
if(hand1.isTouching(p5)){
  abc5 = createSprite(200,200,100,100);
}
...
if(mousePressedOver(p2)){
  //if(!  nada.isPlaying()){
    abcd = createSprite(200,300,100,100);
   // nada.play();
   //}
}
...
if(mousePressedOver(p5)){
 // if(!  whyBuy.isPlaying()){
    whyBuy.play();
   //}
}
if(mousePressedOver(p6)){
  //if(!  whyBuy.isPlaying()){
    whyBuy.play();
   //}
}
if(mousePressedOver(pCorrect)){
